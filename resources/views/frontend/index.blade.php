...
@section('main')
    ...
    <section class="banner">
            ...
            <div class="row align-items-center justify-content-center justify-content-lg-between">
                <div class="col-lg-6 order-0 order-lg-2">
                    <div class="banner__img text-center text-xxl-end">
                        <img src="{{ $pageData->image ? asset($pageData->image) : asset('frontend/assets/img/banner/banner_img.png') }}" alt="">
                    </div>
                </div>
        ...
        <div class="banner__video">
            <a href="{{ $pageData->video_url ?: 'https://www.youtube.com/watch?v=XHOmBV4js_E' }}" class="popup-video"><i class="fas fa-play"></i></a>
